...
int main(int argc, char** argv)
{
  ...
  while (infile.peek() != EOF) {
    ...
    core.im = new CacheMemory<IncompleteMemory, 4, 16, 64>(new IncompleteMemory<4>(im), false);
    core.dm = new CacheMemory<IncompleteMemory, 4, 16, 64>(new IncompleteMemory<4>(dm), true);
