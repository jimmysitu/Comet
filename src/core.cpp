		...
		bool globalStall)
{
    ...
    ac_int<32, false> nextInst, multResult = 0, expectResult = 0;
    ...
    bool expectUsed = core.expectALU.process(core.dctoEx, expectResult, core.stallAlu);	//calling expectALU: execute stage
