...
// Computing the different states of the cache, according to the line size and the interface size
// #define STATE_CACHE_MISS ((LINE_SIZE / INTERFACE_SIZE) * 2 + 2)
// #define STATE_CACHE_LAST_STORE ((LINE_SIZE / INTERFACE_SIZE) + 3)
// #define STATE_CACHE_FIRST_LOAD ((LINE_SIZE / INTERFACE_SIZE) + 2)
// #define STATE_CACHE_LAST_LOAD 2
...
public:
               ...
               ac_int<INTERFACE_SIZE * 8, false>& dataOut, bool& waitOut)
  {
    ...
    this->nextLevel->process(nextLevelAddr, VECT, nextLevelOpType, nextLevelDataIn, nextLevelDataOut, nextLevelWaitOut);
