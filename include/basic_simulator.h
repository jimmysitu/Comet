...
protected:
  ...
  ac_int<COMET_WORD_LENGTH, true> doRead(ac_int<COMET_WORD_LENGTH, false> file,
                                         ac_int<COMET_WORD_LENGTH, false> bufferAddr,
                                         ac_int<COMET_WORD_LENGTH, false> size);
  ac_int<COMET_WORD_LENGTH, true> doWrite(ac_int<COMET_WORD_LENGTH, false> file,
                                          ac_int<COMET_WORD_LENGTH, false> bufferAddr,
                                          ac_int<COMET_WORD_LENGTH, false> size);
  ac_int<COMET_WORD_LENGTH, true> doOpen(ac_int<COMET_WORD_LENGTH, false> name, ac_int<COMET_WORD_LENGTH, false> flags,
                                         ac_int<COMET_WORD_LENGTH, false> mode);
  ac_int<COMET_WORD_LENGTH, true> doOpenat(ac_int<COMET_WORD_LENGTH, false> dir, ac_int<COMET_WORD_LENGTH, false> name,
                                           ac_int<COMET_WORD_LENGTH, false> flags,
                                           ac_int<COMET_WORD_LENGTH, false> mode);
  ac_int<COMET_WORD_LENGTH, true> doLseek(ac_int<COMET_WORD_LENGTH, false> file, ac_int<COMET_WORD_LENGTH, false> ptr,
                                          ac_int<COMET_WORD_LENGTH, false> dir);
  ac_int<COMET_WORD_LENGTH, true> doClose(ac_int<COMET_WORD_LENGTH, false> file);
  ac_int<COMET_WORD_LENGTH, true> doStat(ac_int<COMET_WORD_LENGTH, false> filename,
                                         ac_int<COMET_WORD_LENGTH, false> ptr);
  ...
  ac_int<COMET_WORD_LENGTH, true> doFstat(ac_int<COMET_WORD_LENGTH, false> file,
                                          ac_int<COMET_WORD_LENGTH, false> stataddr);
