...
DEFINES=
FILES=cache.cpp controller.cpp core.cpp elfFile.cpp portability.cpp reformeddm_sim.cpp simulator.cpp
S=./src
S_FILES=$(foreach f, $(FILES), $(S)/$f)
HEADER=cache.h controller.h core.h elf.h elfFile.h portability.h riscvISA.h simulator.h
